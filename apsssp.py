...
app = Flask(__name__)
app.secret_key = os.environ.get('SECRET_KEY', 'ordo_klar_v75_neon_key')

# Conexión a NEON (PostgreSQL)
def get_db_connection():
    # Render te da la URL automáticamente en la variable DATABASE_URL
...
def init_db():
    ...
    cur = conn.cursor()
    # SQL para PostgreSQL (cambia un poco respecto a SQLite)
